...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($email) && !empty($password) && !is_numeric($email))
		{
			...
			//read from database
			$query = "select * from voters where email = '$email' limit 1";
...
<body>
    ...
    <div class="login-box">
        ...
        <a href="index.php"><input id="button" class="btn" type="submit" value="Login"></a><br><br>

    </form>

        <a href="forgotpass.html" class="link">Forgot Password.</a>

        <a href="singup.php" class="link">New user, sign up.</a>
