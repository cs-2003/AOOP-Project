...
session_start();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['btnvote'])) {
            $query = "update votes set votes=votes+1 where id=1 limit 1";
        } 
...
<head>
    ...
    <title>Trinamool Congress</title>
</head>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Trinamool Congress
                    <br class="hidden lg:inline-block">Mamata Banerjee
                </h1>
                <p class="mb-8 leading-relaxed">The All India Trinamool Congress, colloquially the Trinamool Congress is an Indian political party which is predominantly active in West Bengal. The party is led by Mamata Banerjee, 
the current Chief Minister of West Bengal, who has led the state since 2011. </p>
<form method="post">
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <img class="object-cover object-center rounded" alt="hero" src="images/party1.jpg">
            </div>
        </div>
    </section>
