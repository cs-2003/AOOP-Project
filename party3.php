...
session_start();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['btnvote'])) {
            $query = "update votes set votes=votes+1 where id=3 limit 1";
        } 
        if (isset($_POST['btncancel'])) {
            $query = "update votes set votes=votes-1 where id=3 limit 1";
        }
        mysqli_query($con, $query);
        header("Location: party3.php");
			die;
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Indian National Congress
                    <br class="hidden lg:inline-block">Mallikarjun Kharge
                </h1>
                <p class="mb-8 leading-relaxed">The Indian National Congress (INC), colloquially the Congress Party but often simply the Congress, 
is a political party in India with widespread roots. Founded in 1885, it was the first modern 
nationalist movement to emerge in the British Empire in Asia and Africa.</p>
<form method="post">
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <img class="object-cover object-center rounded" alt="hero" src="images/party3.jpg">
            </div>
        </div>
    </section>
